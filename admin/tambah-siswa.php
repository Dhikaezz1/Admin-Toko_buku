...
<form method="post" action="?url=proses-tambah-siswa">
    <div class="form-group mb-2">
        <label>NISN</label>
        <input type="number" name="nisn" placeholder="Masukkan NISN Anda"  class="form-control" required>
    </div>
    <div class="form-group mb-2">
        <label>NIS</label>
        <input type="number" name="nis" placeholder="Masukkan NIS Anda" class="form-control" required>
    </div>
    <div class="form-group mb-2">
        <label>Nama</label>
    ...
    <div class="form-group mb-2">
        ...
        <input type="number" name="no_telp" placeholder="Masukkan NO Telpon Anda"  class="form-control" required>
    </div>
    <div class="form-group mb-2">
        <label>SPP</label>
